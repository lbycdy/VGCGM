...
from utils.misc import (init_random_seed, set_random_seed, setup_logger,
                        worker_init_fn)
from model.modelV010S8S16S32att32depthtwinmaskcatwordbfdecoder import CROG_TWIN
...
def get_parser():
    ...
    parser.add_argument('--config',
                        default='config/OCID-VLG/20241226modelV010depthtwinmaskgrasp0.5catword.yaml',
                        type=str,
                        help='config file')
