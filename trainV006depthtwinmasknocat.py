...
from utils.misc import (init_random_seed, set_random_seed, setup_logger,
                        worker_init_fn)
from model.modelV006depthtwinmasknocat import CROG_TWIN
...
def get_parser():
    ...
    parser.add_argument('--config',
                        default='/home/lbycdy/work/VGCGM/config/OCID-VLG/20241212modelV006depthtwinmaskgrasp0.5nocat.yaml',
                        type=str,
                        help='config file')
