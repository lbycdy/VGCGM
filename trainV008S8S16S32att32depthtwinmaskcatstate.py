...
from utils.misc import (init_random_seed, set_random_seed, setup_logger,
                        worker_init_fn)
from model.modelV008S8S16S32att32depthtwinmaskcatstate import CROG_TWIN
...
def get_parser():
    ...
    parser.add_argument('--config',
                        default='/home/lbycdy/work/VGCGM/config/OCID-VLG/20241222modelV008depthtwinmaskgrasp0.5catstate.yaml',
                        type=str,
                        help='config file')
