...
from utils.misc import (init_random_seed, set_random_seed, setup_logger,
                        worker_init_fn)
from model.modelV012S8S16S32att32depthtwinmaskcatwordbfdecoderonehotshow import CROG_TWIN
...
def get_parser():
    ...
    parser.add_argument('--config',
                        default='config/OCID-VLG/20250118modelV012depthtwinmaskgrasp0.5catwordshow.yaml',
                        type=str,
                        help='config file')
