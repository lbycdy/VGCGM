...
class CROG_TWIN(nn.Module):
    ...
    def forward(self, img,imgdet,imgdepth, word, mask=None, grasp_qua_mask=None, grasp_sin_mask=None, grasp_cos_mask=None,
                grasp_wid_mask=None):
        '''
            img: b, 3, h, w
            word: b, words
        ...
        _, object_features, relationship_features = self.backbone.encode_text_with_objects(word, objects, relationships)
